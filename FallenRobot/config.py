class Config(object):
    ...
    MONGO_DB_URI = "mongodb://Grouphelperlatestbot:<Aakash7@>@<hostname>/?ssl=true&replicaSet=atlas-10bzhd-shard-0&authSource=admin&retryWrites=true&w=majority"  # Get ths value from cloud.mongodb.com
